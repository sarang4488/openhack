...
class ListHackathon extends Component {
  ...
  submitHackathon = e => {
    ...
    axios
      .post(
        `http://localhost:8080/hackathon/?name=${data.name}&start_date=${
          data.startDate
        }&end_date=${data.endDate}&owner_screenname=${
          data.owner
        }&judge_screenname=${data.judge}&min_team_size=${
          data.minTeam
        }&max_team_size=${data.maxTeam}&fee=${data.fee}&discount=${
          data.discount
        }&organization_name=${data.sponsor}`
      )
      .then(response => {
          ...
          <div class="panel login-form">
            <div class="main-div-login">
              ...
              <div class="form-group">
                ...
                <input
                  onChange={this.sponsorChangeHandler}
                  type="text"
                  class="form-control"
                  name="description"
                  id="sponsor"
